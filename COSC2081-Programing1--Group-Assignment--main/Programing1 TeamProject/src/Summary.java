...
public class Summary {
    ...
    String csv = "Programing1 TeamProject/src/data.csv";
    String line = "";
    String ChoiceMetric = "";
    String TypeOfResult = "";
    String option = "";
    ...
    public void getData() throws IOException {
        ...
        for (String e : this.ByAreaArray) {
            if (isCarried(e, user.RangeOfTime[0]) != true) {
        ...
        for (String e : this.ByAreaArray) {
            for (int i = 0; i < user.RangeOfTime.length; i++) {
                if (isCarried(e, user.RangeOfTime[i]) == true) {
 ...
 public void GroupOfData() {
    ...
    switch (option) {
        ...
        case "3":
            ...
            // Input again if user input is invalid
            while (check) {
                if (checkDivisible(this.InsertDays) != true) {
                    Invalid();
    ...
    // display
    public void convertnewTotalToString() {
    ...
    public void convertTimeToArray() {
        ...
        if (this.option.equals("1")) {
            ...
            if (this.ValueOfGroup == TimeRange.size()) {
                for (int i = 0; i < this.dataCheckTime.size(); i++) {
                    groupFirstDate = this.dataCheckTime.get(i).get(0);
                    this.TimeToString.add(groupFirstDate);
                }
